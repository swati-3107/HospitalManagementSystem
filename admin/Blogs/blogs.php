     ...
     <div class="page-header">
        ...
        <div class="container-fluid">
           ...
           <div class="pull-right">
              ...
              <a href="<?php echo $base_path;?>admin/Blogs/add_blogs.php" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>

           </div>

           <h1>Blogs/News Update</h1>
                   ...
                   <table class="table  table-bordered table-hover" id="dataTables-example" style="width:100%;">
                     ...
                     <thead>
                       ...
                       <tr>
                         ...
                         <td class="text-left text-info">Blog name</td>

                         <td class="text-left text-info">Image</td>

                         <td class="text-left text-info">Blog details</td>

                         <td class="text-left text-info">more_Blog_details</td> 
...

                           {
                            ...
                            ?>
                             ...
                             <tr>
                                 ...
                                 <td class="text-left"><?php echo $row['facility_name'];?></td>

                                 <td class="text-left"><img src="<?php $base_path;?>gallery_images/<?php echo $row['gallery_image'];?>" target="_blank" height="40px"></td>

                                 <td class="text-left"><?php echo $row['facility_details'];?></td>
                                 <td class="text-left"><?php echo $row['more_facility_details'];?></td>
                                 ...
                                 <td class="text-right">
                                   ...
                                   <a href="<?php $base_path;?>admin/Blogs/blogs.php?edit&id=<?php echo $row['id'];?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

                                   <a href="<?php $base_path;?>admin/Blogs/blogs.php?delete&id=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Do you really want to Delete...?')" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                 ...
                 <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                    {
                       ...
                       $sql  = "update `news_update` set `facility_name`='$facility_name', `facility_details`='$facility_details',`more_facility_details`='$more_facility_details' where id=$id";
...

                                {
...

                                   {
...

                                      {
                                         ...
                                         $sql = "update gallery set news_update = \"$gallery_image\" where id=$id";
                 ...
                 <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      ...
                      <input type="text" class="form-control" name="facility_name" id="name" placeholder="name" value="<?=$facility_name?>" >
                 ...
                 <div class="form-group">
                    ...
                    <label class="control-label col-sm-2" for="facility_details">facility_details:</label>

                    <div class="col-sm-10">

                       <textarea type="text" id="facility" class="form-control" rows="7" name="facility_details"  placeholder="feedback"><?=$facility_details?></textarea>
                 ...
                 <div class="form-group">
                    ...
                    <label class="control-label col-sm-2" for="facility_details">more_facility_details:</label>

                    <div class="col-sm-10">

                       <textarea type="text" id="more_facility" class="form-control" rows="7" name="more_facility_details"  placeholder="more_facility"><?=$more_facility_details?></textarea>
