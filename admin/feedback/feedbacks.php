     ...
     <div class="page-header">
        ...
        <div class="container-fluid">
           ...
           <div class="pull-right">
              ...
              <a href="<?php echo $base_path;?>admin/feedback/add_paitent_feedback.php" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                   ...
                   <table class="table  table-bordered table-hover" id="dataTables-example" style="width:100%;">
                     ...
                     <thead>
                       ...
                       <tr>
                         ...
                         <td class="text-left text-info">feedback image</td>

                         <td class="text-left text-info">feedback</td>
<!-- 
                         <td class="text-left text-info">Rate</td> -->
...

                           {
                            ...
                            ?>
                             ...
                             <tr>
                                 ...
                                 <!-- <td class="text-left"><?php echo $row['Rate'];?></td> -->

                                 

                                 <td class="text-right">

                                   <a href="<?php $base_path;?>admin/feedback/feedbacks.php?edit&id=<?php echo $row['id'];?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

                                   <a href="<?php $base_path;?>admin/feedback/feedbacks.php?delete&id=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Do you really want to Delete...?')" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
            ...
            <?php
              ...
              $sql = "select * from feedback_student where id = $id";
           ...
           ?>
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                 ...
                 <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                    {
                       ...
                       $sql  = "update `feedback_student` set `name`='$name', `feedback`='$feedback' where id=$id";
...

                                {
...

                                   {
...

                                      {
                                         ...
                                         $sql = "update gallery set feedback_student = \"$gallery_image\" where id=$id";
                 ...
                 <div class="form-group">
                    ...
                    <label class="control-label col-sm-2" for="description">Feedbacck:</label>

                    <div class="col-sm-10">

                       <textarea type="text" class="form-control" rows="7" name="feedback" id="feedback" placeholder="feedback"><?=$feedback?></textarea>
...

            {
...

                             {
                                 ...
                                 $sql = "delete from feedback_student where id = $id";
