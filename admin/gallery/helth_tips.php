     ...
     <div class="page-header">
        ...
        <div class="container-fluid">
           ...
           <div class="pull-right">
              ...
              <a href="<?php echo $base_path;?>admin/gallery/add-helth-tips.php" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
           ...
           <ul class="breadcrumb">
              ...
              <li><a href="<?php echo $base_path;?>admin/gallery/helth_tips.php">Health Tips</a></li>
        ...
        <div class="panel panel-default">
           ...
           <div class="panel-body">
                            ...
                            ?>
                             ...
                             <tr>
                                 ...
                                 <td class="text-right">
                                   ...
                                   <a href="<?php $base_path;?>admin/gallery/helth_tips.php?edit&id=<?php echo $row['id'];?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

                                   <a href="<?php $base_path;?>admin/gallery/helth_tips.php?delete&id=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Do you really want to Delete...?')" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
            ...
            <?php
              ...
              $sql = "select * from  helth_tips where id = $id";
           ...
           ?>
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                 ...
                 <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                    {
                       ...
                       $sql  = "update `helth_tips` set image_caption=\"$image_caption\", description=\"$description\", category=\"$category\" , Height=\"$Height\", Width=\"$Width\" where id=$id";
...

                       {
                         ...
                         <div class="alert alert-success alert-dismissible" role="alert" style="margin-bottom: 20px;">
                            ...
                            <strong>Success !</strong>  Health Tips Successfully updated.
...

                                {
...

                                   {
...

                                      {
                                         ...
                                         $sql = "update  helth_tips set gallery_image = \"$gallery_image\" where id=$id";
...

            {
...

                             {
                                 ...
                                 $sql = "delete from  helth_tips where id = $id";
...

                                 {
                                    ...
                                    <div class="alert alert-danger alert-dismissible" role="alert" style="margin-bottom: 20px;">
                                      ...
                                      <strong>Warning !</strong>  Can't delete Image.Please try again.
