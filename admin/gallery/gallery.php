     ...
     <div class="page-header">
        ...
        <div class="container-fluid">
           ...
           <div class="pull-right">
              ...
              <a href="<?php echo $base_path;?>admin/gallery/add-gallery.php" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
                            ...
                            ?>
                             ...
                             <tr>
                                 ...
                                 <td class="text-right">
                                   ...
                                   <a href="<?php $base_path;?>admin/gallery/gallery.php?edit&id=<?php echo $row['id'];?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

                                   <a href="<?php $base_path;?>admin/gallery/gallery.php?delete&id=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Do you really want to Delete...?')" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                 ...
                 <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                    {
                       ...
                       $sql  = "update `gallery` set image_caption=\"$image_caption\", description=\"$description\", category=\"$category\" , height=\"$height\", width=\"$width\" where id=$id";
...

                                {
...

                                   {
...

                                      {
                                         ...
                                         $sql = "update gallery set gallery_image = \"$gallery_image\" where id=$id";
