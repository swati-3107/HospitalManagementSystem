     ...
     <div id="content">
        ...
        <div class="page-header">
           ...
           <div class="container-fluid">
              ...
              <div class="pull-right"><a href="<?php echo $base_path;?>admin/gallery/achivements.php" data-toggle="tooltip" title="Cancel" class="btn btn-default"><i class="fa fa-reply"></i></a></div>
        ...
        <div class="container-fluid">
           ...
           <div class="panel panel-default">
              ...
              <div class="panel-heading"><h3 class="panel-title"><i class="fa fa-pencil"></i> <?php if(isset($_REQUEST['edit'])){echo 'Edit';}else{echo 'Add';}?> Achivements</h3></div>
                    ...
                    <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                       {
...

                          {
                             ...
                             $sql  = "INSERT INTO `achivements` (`id`, `gallery_image`, `image_caption`, `description`, `category` , `date_added`)

                             VALUES (NULL, \"$gallery_image\", \"$image_caption\", \"$description\", \"$category\", CURRENT_TIMESTAMP)";
