...
<body>
   ...
   <div id="content">
     ...
     <div class="page-header">
        ...
        <div class="container-fluid">
           ...
           <div class="pull-right">
              ...
              <a href="<?php echo $base_path;?>admin/gallery/add-achivements.php" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a>
           ...
           <ul class="breadcrumb">
              ...
              <li><a href="<?php echo $base_path;?>admin/gallery/achivements.php">achivements</a></li>
        ...
        <div class="panel panel-default">
           ...
           <div class="panel-body">
                            ...
                            ?>
                             ...
                             <tr>
                                 ...
                                 <td class="text-right">
                                   ...
                                   <a href="<?php $base_path;?>admin/gallery/achivements.php?edit&id=<?php echo $row['id'];?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

                                   <a href="<?php $base_path;?>admin/gallery/achivements.php?delete&id=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Do you really want to Delete...?')" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
            ...
            <?php
              ...
              $sql = "select * from achivements where id = $id";
              ...
              <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                 ...
                 <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                    {
                       ...
                       $sql  = "update `achivements` set image_caption=\"$image_caption\", description=\"$description\", category=\"$category\" , department=\"$department\" where id=$id";
...

                                {
...

                                   {
...

                                      {
                                         ...
                                         $sql = "update achivements set gallery_image = \"$gallery_image\" where id=$id";
    ...
    <label class="control-label col-sm-2">Select Department</label>
 ...
 echo "<option value='other'>Photo Gallery</option>";
            }
