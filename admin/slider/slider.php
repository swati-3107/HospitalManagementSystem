  ...
  <div class="container-fluid">
      ...
      <div class="panel-body">
       ...
       if(isset($_POST['table']))
       {
        ...
        {
         $id = $_POST['selected'][$i];
         $sql = "select $file_col_name,compressed_image from $table where id=$id ";
         ...
         if(file_exists($path.$file))
         {
          ...
          if(isset($compressed_image) && $compressed_image!='na')
         {
           if(file_exists($path."compressed/".$compressed_image))
           {
             unlink($path."compressed/".$compressed_image);
           }
         }
            ...
            <table class="table  table-bordered table-hover" id="dataTables-example" style="width:100%;">
              <thead>
                <tr>
                  ...
                  <td class="text-right text-info">Slider For</td>
                 ...
                 for($i=1;$i<=$num;$i++)
                 {
                  ...
                  ?>
                   <tr>
                       ...
                       <td class="text-left"><img height="40px" src="<?php $base_path;?>slider_images/compressed/<?php echo $row['compressed_image'];?>" target="_blank"></td>
   ...
   <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
                ...
                if(isset($_POST['edit']))
                {
                 ...
                 extract($post);
                 $sql  = "update `index_slider` set type=\"$type\", slider_caption=\"$slider_caption\", slider_date_from = \"$slider_date_from\",slider_date_to=\"$slider_date_to\" where id=$id";
                     ...
                     if($res)
                     {
                       ...
                       if(!empty($_FILES['slider_image']['name']))
                       {
                        ...
                        $sql = "select slider_image,compressed_image from index_slider where id = $id";
                  ...
                  if(isset($compressed_image) && $compressed_image!='na')
                 {
                   if(file_exists("../../slider_images/compressed/".$compressed_image))
                   {
                     unlink("../../slider_images/compressed/".$compressed_image);
                   }
                 }
