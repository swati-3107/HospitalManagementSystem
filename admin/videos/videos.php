  ...
  <div class="page-header">
    ...
    <div class="container-fluid">
      ...
      <div class="pull-right">
        ...
        <a href="<?php echo $base_path;?>admin/videos/add-video.php" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a></div>
            ...
            <table class="table  table-bordered table-hover" id="dataTables-example" style="width:100%;">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td class="text-right text-info">Video ID</td>

                  <td class="text-left text-info">Video Caption</td>

                  <td class="text-left text-info">Video</td>
...
//id	video_title	video_description	video_date	video_embed_code
                  ...
                  ?>
                   ...
                   <tr>
                       ...
                       <td class="text-left"><?php echo $row['video_title'];?></td>

                       <td class="text-left"><iframe width="200" height="105" src="<?php echo $row['video_embed_code'];?>"></iframe></td>
                       
                       <td class="text-left"><?php echo $row['video_description'];?></td>
                       
                       
                       <!-- <td class="text-left"><?php echo $row['Action'];?></td> -->
                       <td class="text-right">

                         <a href="<?php $base_path;?>admin/videos/videos.php?edit&id=<?php echo $row['id'];?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>

                         <a href="<?php $base_path;?>admin/videos/videos.php?delete&id=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Do you really want to Delete...?')" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a>
...
//Edit form action statrs from here
  ...
  <div class="form-group">
    ...
    <label class="control-label col-sm-2" for="caption">Video Title:</label>

    <div class="col-sm-10">

      <input type="hidden" name="id" value="<?=isset($id)?$id:""?>">

      <input type="text" class="form-control" name="video_title" id="video_title" placeholder="Enter Video title" value="<?=isset($video_title)?stripslashes($video_title):''?>">
 ...
 <div class="form-group">
    ...
    <div class="col-sm-10"> 
      ...
      <textarea class="form-control" id="video_description " name="video_description" rows="6" placeholder="Short description about video"><?=isset($video_description)?stripslashes($video_description):''?></textarea>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10"> 
      ...
      <textarea class="form-control" id="video_embed_code" name="video_embed_code" rows="6" placeholder="Copy Youtube embed code here"><?=isset($video_embed_code)?stripslashes($video_embed_code):''?></textarea>
...

                           {
                             ...
                             ?>
                               ...
                               <div class="alert alert-success alert-dismissible" role="alert" style="margin-bottom: 20px;">
                                 ...
                                 <strong>Success !</strong>  Video  Successfully removed from website.
