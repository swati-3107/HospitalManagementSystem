  ...
  <div class="page-header">
    ...
    <div class="container-fluid">
      ...
      <div class="pull-right">
          ...
          <a href="<?php echo $base_path;?>admin/facilities/add-facilities.php" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a></div>
      ...
      <ul class="breadcrumb">
                ...
                <li><a href="<?php echo $base_path;?>admin/facilities/add-facilities.php">Add Facilities</a></li>
            ...
            <table class="table  table-bordered table-hover" id="dataTables-example" style="width:100%;">
              ...
              <thead>
                ...
                <tr>
                  ...
                  <td class="text-left text-info">Facility Name</td>



                  <td class="text-left text-info">Facility Details</td>
...

                 {
                  ...
                  ?>
                   ...
                   <tr>
                       ...
                       <td class="text-left"><img src="<?php $base_path;?>service_image/<?php echo $row['photo'];?>" target="_blank" height="40px"></td>
                       ...
                       <td class="text-right">
                         ...
                         <a href="<?php $base_path;?>admin/facilities/stud-facilities.php?edit&id=<?php echo $row['id'];?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                         ...
                         <a href="<?php $base_path;?>admin/facilities/stud-facilites.php?delete&id=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Do you really want to Delete...?')" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
    ...
    <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
...

                {
                 ...
                 extract($post);
                  ...
                  $sql  = "update `facilities` set `facility_name`=\"$facility_name\" where id=$id";
                   ...
                   <div class="form-group">
                     ...
                     <div class="form-group">
                        ...
                        <div class="col-sm-10">
							  ...
							  <textarea class="form-control" name="facility_details" id="facility_details" placeholder="Event Details" rows="6" ><?=$facility_details?></textarea>
					   ...
					   <div class="form-group">
                        ...
                        <div class="col-sm-10"> 
                          ...
                          <input type="file" class="form-control" id="photo" name="photo" value="<?=$photo?>" >
							...
							<small>Choosing new image will replace old image <a href="<?php $base_path;?>service_image/<?php echo $row['photo'];?>"><?=$photo?></a></small>
