  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <a href="<?php echo $base_path;?>admin/social/add-link" data-toggle="tooltip" title="Add New" class="btn btn-primary"><i class="fa fa-plus"></i></a></div>
            ...
            <table class="table  table-bordered table-hover" id="dataTables-example" style="width:100%;">
              <thead>
                <tr>
                  ...
                  <td class="text-right text-info">Links ID</td>
                  <td class="text-left text-info"> Name</td>
                  <td class="text-right text-info">Link</td>
               ...
               extract($row);
                  ?>
                   <tr>
                       ...
                       <td class="text-left"><a href="<?php echo $row['link'];?>"><?php echo $row['link'];?></a></td>
                       <td class="text-right">
                         <a href="<?php $base_path;?>admin/social/links?edit&id=<?php echo $row['id'];?>" data-toggle="tooltip" title="Edit" class="btn btn-primary"><i class="fa fa-pencil"></i></a>
                         <a href="<?php $base_path;?>admin/social/links?delete&id=<?php echo $row['id']; ?>" onClick="javascript:return confirm('Do you really want to Delete...?')" data-toggle="tooltip" title="Delete" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
                   </tr>
               <?php
                 }
               }else{
...
//Edit form action statrs from here
   ...
   <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="col-md-10 col-md-offset-2" style="padding: 0px;">
                ...
                if(isset($_POST['edit']))
                {
                 ...
                 extract($post);
                 $sql  = "update `social_links` set name=\"$name\",
                 link = \"$link\",icon=\"$icon\" where id=$id";
  ...
  <div class="form-group">
   ...
   <div class="col-sm-10">
     <input type="text" name="name" value="<?=$name?>" class="form-control" required placeholder="Social Media name">
   </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
     <select name="icon" class="form-control" id="icon" style="font-family: 'FontAwesome',sans-serif;font-size: 16px;">
            ...
            <option value="fa fa-whatsapp" class="fa">&#xf232;  Whatsapp</option>
            <option value="fa fa-youtube-square" class="fa">&#xf166;  Youtube</option>
     </select>
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-10">
      <input type="url" class="form-control" name="link" id="link" placeholder="Enter Link Link" value="<?=$link?>">
    </div>
  </div>
